package com.thepirates.util;

import java.io.File;

public enum OSHelper {
	  WINDOWS("AppData" + File.separator + "Roaming" + File.separator + ".thepirates"),
	  MAC("Library" + File.separator + "Applacation Support" + File.separator + "thepirates"),
	  LINUX(".thepirates");
